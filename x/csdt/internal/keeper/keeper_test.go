...
func TestKeeper_ModifyCSDT(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			}, cs(c("uftm", 10), c(StableDenom, 2)), i(2),
				CollateralState{Denom: "uftm", TotalDebt: i(2), TotalCash: u(0), TotalBorrows: u(0), Reserves: u(0)},
				cs(c("uftm", 100))},
			"10.345",
			...
			}, cs( /*  0uftm  */ c(StableDenom, 1)), i(1),
				CollateralState{Denom: "uftm", TotalDebt: i(1), TotalCash: u(0), TotalBorrows: u(0), Reserves: u(0)},
				cs(c("uftm", 110))},
		},
		{
			...
			}, cs(c("uftm", 10), c(StableDenom, 10)), i(200),
				CollateralState{Denom: "uftm", TotalDebt: i(200), TotalCash: u(1000), TotalBorrows: u(0), Reserves: u(0)},
				cs(c("uftm", 1000))},
			"1.00",
		...
		},
		{
			...
			state{CSDT{
				...
				CollateralState{Denom: "uftm", TotalDebt: i(200), TotalCash: u(0), TotalBorrows: u(0), Reserves: u(0)},
				cs(c("uftm", 1000))},
			"1.00",
		...
		},
		{
			...
			state{CSDT{}, cs(c("uftm", 10), c(StableDenom, 10)), i(0),
				CollateralState{Denom: "uftm", TotalDebt: i(0), TotalCash: u(0), TotalBorrows: u(0), Reserves: u(0)},
				cs(c("uftm", 0))},
			"1.00",
			...
			state{CSDT{
				...
				Debt:             cs(c(StableDenom, 2)),
			}, cs(c("uftm", 5), c(StableDenom, 12)), i(2),
				CollateralState{Denom: "uftm", TotalDebt: i(2), TotalCash: u(0), TotalBorrows: u(0), Reserves: u(0)},
				cs(c("uftm", 5))},
		},
		{
			...
			state{CSDT{
				...
				CollateralAmount: cs(c("uftm", 1000)),
				Debt:             cs(c(StableDenom, 200)),
			}, cs(c("uftm", 10), c(StableDenom, 201)), i(200),
				CollateralState{Denom: "uftm", TotalDebt: i(200), TotalCash: u(1000), TotalBorrows: u(0), Reserves: u(0)},
				cs(c("uftm", 1000))},
			"1.00",
			args{ownerAddr, "uftm", i(-1000), i(-200)},
			true,
			state{CSDT{}, cs(c("uftm", 1010), c(StableDenom, 1)), i(0),
				CollateralState{Denom: "uftm", TotalDebt: i(0), TotalCash: u(1000), TotalBorrows: u(0), Reserves: u(0)},
				cs(c("uftm", 0))},
		},
		{
