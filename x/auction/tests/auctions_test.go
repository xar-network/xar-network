...
func TestForwardAuction_PlaceBid(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args{now, buyer2, c("ftg", 100), c("ftm", 10)},
		...
		},
		{
			...
			args{now, buyer2, c("ftg", 100), c("ftm", 5)},
			[]bankOutput{},
			[]bankInput{},
			end,
			buyer1,
		...
		},
		{
			...
			args{now, buyer2, c("ftg", 100), c("ftm", 6)},
			[]bankOutput{},
			[]bankInput{},
			end,
			buyer1,
		...
		},
		{
			...
			args{end + 1, buyer2, c("ftg", 100), c("ftm", 10)},
			[]bankOutput{},
			[]bankInput{},
			end,
			buyer1,
...
func TestReverseAuction_PlaceBid(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args{now, seller2, c("ftm", 9), c("ftg", 100)},
			[]bankOutput{{seller2, c("ftg", 100)}},
			[]bankInput{{seller1, c("ftg", 100)}, {buyer, c("ftm", 1)}},
			now + BidDuration,
			seller2,
			c("ftm", 9),
			true,
		},
		{
			...
			args{now, seller2, c("ftm", 11), c("ftg", 100)},
			[]bankOutput{},
			[]bankInput{},
			end,
			seller1,
		...
		},
		{
			...
			args{now, seller2, c("ftm", 10), c("ftg", 100)},
			[]bankOutput{},
			[]bankInput{},
			end,
			seller1,
		...
		},
		{
			...
			args{end + 1, seller2, c("ftm", 9), c("ftg", 100)},
			[]bankOutput{},
			[]bankInput{},
			end,
			seller1,
...
func TestForwardReverseAuction_PlaceBid(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args{now, buyer2, c("xrp", 100), c("ftg", 6)},
			[]bankOutput{{buyer2, c("ftg", 6)}},
			[]bankInput{{buyer1, c("ftg", 5)}, {seller, c("ftg", 1)}},
			now + BidDuration,
			buyer2,
			c("xrp", 100),
			c("ftg", 6),
		...
		},
		{
			...
			args{now, buyer2, c("xrp", 99), c("ftg", 10)},
			[]bankOutput{{buyer2, c("ftg", 10)}},
			[]bankInput{{buyer1, c("ftg", 5)}, {seller, c("ftg", 5)}, {cdpOwner, c("xrp", 1)}},
			now + BidDuration,
			buyer2,
			c("xrp", 99),
			c("ftg", 10),
		...
		},
		{
			...
			args{now, buyer2, c("xrp", 90), c("ftg", 10)},
			[]bankOutput{{buyer2, c("ftg", 10)}},
			[]bankInput{{buyer1, c("ftg", 10)}, {cdpOwner, c("xrp", 9)}},
			now + BidDuration,
			buyer2,
			c("xrp", 90),
			c("ftg", 10),
