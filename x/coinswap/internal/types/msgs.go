...
type MsgSwapOrder struct {
	...
	Output    sdk.Coin       `json:"output"` // the amount the sender is receiving
...
func (msg *MsgSwapOrder) IsDoubleSwap(nativeDenom string) bool {
	return msg.Input.Denom != nativeDenom && msg.Output.Denom != nativeDenom
}
...
// Route Implements Msg.
func (msg MsgTransactionOrder) Route() string { return RouterKey }

// Type Implements Msg.
func (msg MsgTransactionOrder) Type() string { return "transaction_order" }
...
func (msg MsgTransactionOrder) ValidateBasic() sdk.Error {
	...
	if msg.Sender.Equals(msg.Recipient) {
		return sdk.ErrInvalidAddress("recipient and sender cannot be equal")
	}
