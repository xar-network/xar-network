...
// get the minter
func (k Keeper) GetState(ctx sdk.Context) (is types.InterestState) {
...
func (k Keeper) SetState(ctx sdk.Context, is types.InterestState) {
	store := ctx.KVStore(k.storeKey)
	b := k.cdc.MustMarshalBinaryLengthPrefixed(is)
	store.Set(types.MinterKey, b)
}

func (k Keeper) SetInterest(ctx sdk.Context, newInterest sdk.Dec, denom string) sdk.Result {
