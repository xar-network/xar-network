...
Zar genesis state, `GenesisState`, is composed of accounts, various module
...
The Zar genesis state is defined as follows:
...
In the ABCI `initChainer` definition of Zar the `initFromGenesisState` is called
