...
of Zar to use and details about the genesis file.
:::
...
See the [testnet repo](https://github.com/cosmos/testnets) for details on which version is needed for which testnet, and the [Zar release page](https://github.com/zar-network/zar-network/releases) for details on each release.
