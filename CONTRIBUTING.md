...
contributors, the general procedure for contributing has been established:
  ...
  1. either [open](https://github.com/zar-network/zar-network/issues/new/choose) or
     [find](https://github.com/zar-network/zar-network/issues) an issue you'd like to help with,
  ...
  3. if you would then like to contribute code:
     ...
     4. follow standard github best practices: fork the repo, branch from the
       top of `master`, make some commits, and submit a PR to `master`,
         - for core developers working within the Zar repo,
...
Other notes:
  - Looking for a good place to start contributing? How about checking out some
    [good first issues](https://github.com/zar-network/zar-network/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
If you open a PR in Zar, it is mandatory to update the relevant documentation in /docs.

* If your changes relate specifically to the zar application, please modify the docs/ folder.

## Forking

Please note that Go requires code to live under absolute paths, which complicates forking.
While my fork lives at `https://github.com/rigeyrigerige/zar`,
the code should never exist at  `$GOPATH/src/github.com/rigeyrigerige/zar`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,
`$GOPATH/src/github.com/zar-network/zar-network `, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

  - Create the fork on github, using the fork button.
  - Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/zar-network/zar-network`)
  - `git remote rename origin upstream`
  - `git remote add origin git@github.com:rigeyrigerige/zar.git`

Now `origin` refers to my fork and `upstream` refers to the Zar version.
So I can `git push -u origin master` to update my fork, and make pull requests to Zar from there.
...
Zar utilizes [semantic versioning](https://semver.org/).
...
### Development Procedure
  ...
  - create a development branch either on github.com/zar-network/zar-network, or your fork (using `git remote add origin`)
